...
// Multiply coefficient by B inverse
   ...
   BinvMultiply_B6(tree[panel_index].moments1, tm1);
   BinvMultiply_B6(tree[panel_index].moments2, tm2);
   BinvMultiply_B6(tree[panel_index].moments3, tm3);
    ...
    if (tree[panel_index].MAC < R_sq)
      {
        ...
        Compute_Coeff_B6(p_x, p_y, p_z, panel_index);
       ...
       for (size_t k = 1; k < size; k++) // skip root
         {
           ...
           BinvMultiply_Transpose_B6(tm1, tree[k].moments1);
           BinvMultiply_Transpose_B6(tm1x, tree[k].dxmoments1);
           BinvMultiply_Transpose_B6(tm1y, tree[k].dymoments1);
           BinvMultiply_Transpose_B6(tm1z, tree[k].dzmoments1);

           BinvMultiply_Transpose_B6(tm2, tree[k].moments2);
           BinvMultiply_Transpose_B6(tm2x, tree[k].dxmoments2);
           BinvMultiply_Transpose_B6(tm2y, tree[k].dymoments2);
           BinvMultiply_Transpose_B6(tm2z, tree[k].dzmoments2);

           BinvMultiply_Transpose_B6(tm3, tree[k].moments3);
           BinvMultiply_Transpose_B6(tm3x, tree[k].dxmoments3);
           BinvMultiply_Transpose_B6(tm3y, tree[k].dymoments3);
           BinvMultiply_Transpose_B6(tm3z, tree[k].dzmoments3);
...
// Output to file
    ...
    output_file.open("output_RS_C0.txt", ios::out | ios::ate | ios::app);
